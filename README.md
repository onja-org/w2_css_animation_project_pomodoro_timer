...
This is your first project that combines HTML, CSS, **and JavaScript**! Don't worry - you won't write JavaScript yet. Instead, you'll learn how HTML elements can be connected to JavaScript functionality, and how CSS makes everything look polished and professional.
...
- Sound effects (using CSS tricks!)
...
**CSS-Only Sound**
Can you create the illusion of sound using visual feedback?
...
5. **Have fun** - This is your first interactive project. Experiment!
...
Take a screenshot of your timer in both work and break modes - you might want to reference this design in future projects!

---

*Remember: The goal isn't just to make it work, but to make it delightful to use. Every animation should have purpose, every color should set a mood, and every interaction should feel satisfying.*
